...
// array, if either vector's length disagrees with the joint count, or if any joint is not an
// independent revolute joint or already carries a limit of its own.
